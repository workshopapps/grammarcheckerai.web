    ...
    <main className='bg-white h-screen pt-2 sm:pt-16'>
        ...
        <div className='w-[90%] md:w-[80%] h-[95%] flex flex-col m-auto'>
            <div className='flex flex-col sm:flex-row justify-between items-center pb-3 border-none sm:border-b-[3px] border-[#d2d2d2]/50 relative'>
                ...
                <span className='font-bold flex justify-center items-center text-center bg-[#5d387f] text-white rounded-full text-3xl sm:text-2xl h-24 w-24 mt-3 md:mt-0 sm:h-12 sm:w-12 uppercase'>{data.firstName.charAt(0)+ "" + data.lastName.charAt(0)}</span>
            </div>
            ...
            <div className='flex flex-col gap-10 mt-5'>
                ...
                <div className='relative border-b-[3px] border-[#d2d2d2]/50'>
                    ...
                    {
                        !openEdit ? <p className='text-lg'>{data.username}</p> : 
                    <form onSubmit={(e) => ChangeUsername(e)}>
                        <input
                            ...
                            required 
                            />
                            <input className={openEdit ? 'bg-[#5d387f] text-white p-2 rounded absolute bottom-2 right-0 cursor-pointer' : 'hidden'} type="submit" value="update" />
                    </form>
                    }
                    <span onClick={() => setOpenEdit(!openEdit)} className={openEdit ? 'hidden' : 'absolute bottom-2 right-0 cursor-pointer'}><img src={editicon} alt="edit" /></span>
                </div>
                ...
                <div className='relative flex flex-col border-b-[3px] border-[#d2d2d2]/50'>
                    ...
                    <input type="password" name="password" value={data.password.substring(0,10)} disabled className='text-xl bg-transparent' />
                    <p></p>
