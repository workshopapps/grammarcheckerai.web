    ...
    <div>
        ...
        <div className='px-8 md:px-10 py-10'>
            ...
            <ol className="list-decimal flex flex-col gap-4">
                <li>
                    <span>Creating a Speak Better Account</span>
                    <p>
                ...
                <li>
                    <span>Privacy and Consumer Information</span>
                    <p>
                ...
                <li>
                    <span>Content and Intellectual Property Rights</span>
                    <p>
                ...
                <li>
                    ...
                    <span>Speak Better may terminate your right to use the Services at any time</span>
                ...
                <li>
                    <span>Release and Indemnification</span>
                    <p>
