        ...
        <div>
            <div className='py-10 text-center bg-[#E8DDF2] text-BLACK'>
                <div className="goback pb-30">
                    <button onClick={handlePrev} className="bg-purple-500 hover:bg-purple-900 text-white py-2 px-2 ml-10 flex items-center mt-0 lg:absolute w-36 h-12 sm: relative sm:float-top">
