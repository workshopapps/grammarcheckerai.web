    ...
    <section className="mb-10">
      <div className="mt-10 md:max-w-3xl md:mx-auto xl:max-w-5xl">
        ...
        <div className="p-4 py-4">
          ...
          <p className="font-normal text-base mb-3">
            1. Read as much as you can - reading is a great way to familiarize yourself with the correct grammar for
            different contexts and situations.
          </p>

          <p className="font-normal text-base mb-3">
            2. Practice using your grammar skills by writing or speaking - this will help you remember the rules and
            apply them in real-world situations.
          </p>

          <p className="font-normal text-base mb-3">
            3. Make an effort to recognize mistakes in your own writing - self-evaluation is key to improving your
            grammar skills.
          </p>

          <p className="font-normal text-base mb-3">
            4. Find a mentor or teacher who can give you feedback and help you improve - having someone to help guide
            you through the process is invaluable for learning grammar.2. Practice using your grammar skills by writing
            or speaking - this will help you remember the rules and apply them in real-world situations.
          </p>

          <p className="font-normal text-base mb-3">
            5. Use grammar resources like apps or websites - there are many great online tools that can help you hone
            your grammar skills. With some dedication and practice, you can become an expert on English grammar in no
            time! Improve your grammar every day and you will see a remarkable difference in your ability to communicate
