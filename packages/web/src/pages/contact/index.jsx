...
const  index = () => {
  return (
    ...
    <div className={ContactCSS.container}>
        <p className={ContactCSS.p1}>Contact Us</p>
        <p className={ContactCSS.p2}> We would love to hear from you</p>
        <p className={ContactCSS.p3}>Any questions or remarks? Just write us a message!</p>
        <form>
