    ...
    <section>
      <div className="p-4 grid grid-cols-2 gap-12 gap-y-8 mb-10 md:max-w-3xl mx-auto xl:grid-cols-3 xl:max-w-6xl">
        ...
        <div className="flex justify-center items-center xl:hidden">
          <button className="bg-btn relative text-white px-3 py-2 pl-4 flex justify-center items-center cursor-pointer rounded-md hover:bg-[#3d1762]">
            See more
      ...
      <div className="xl:flex justify-center items-center xl:mx-auto hidden">
        <button className="bg-btn relative text-white px-3 py-2 flex justify-center items-center cursor-pointer rounded-md hover:bg-[#3d1762]">
          See more
          <img src={Icon} alt="" className="ml-2" />
        </button>
      </div>
