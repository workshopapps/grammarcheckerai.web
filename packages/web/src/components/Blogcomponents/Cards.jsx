...
const Cards = () => {
  ...
  return (
    <section className="">
      <div className="px-8 mt-12 p-2 max-w-sm py-2 grid gap-x-8 grid-cols-1 gap-y-2 md:gap-y-8 md:grid-cols-2 mb-4 md:max-w-4xl mx-auto xl:grid-cols-3 xl:max-w-6xl xl:p-0">
        <div
        ...
        >
          ...
          <p
            ...
            } text-left font-normal text-sm mb-4 xl:text-base`}
          >
