     ...
     return(
          <section>
               <div className="p-4 mb-5 md:flex justify-between items-center md:max-w-3xl md:mx-auto">
                    ...
                    <div>
                         <h1 className={`text-header ${dark ? 'text-white' : null} text-xl font-bold mb-3 text-center xl:text-xl`}>Enjoyed the read?</h1>

                         <p className={` text-cards ${dark ? 'text-white' : null} font-normal text-sm mb-5 mx-auto max-w-xs xl:text-base`}>Join our monthly newsletter for helpful tips on how to learn languages fluently and AI tecnology.</p>
