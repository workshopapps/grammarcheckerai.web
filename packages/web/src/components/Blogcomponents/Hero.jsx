...
const Hero = () => {
  ...
  return (
    <section className="">
      <div className="md:flex px-4 justify-between items-center md:max-w-3xl md:px-4 flex-row-reverse mt-8  md:mx-auto xl:max-w-6xl xl:p-0">
        <div className={`mb-4 h-48 md:w-96 md:mb-0 md:p-0 xl:w-1/2 ${styles._img_height}`}>
          <img src={Heroimg} alt="Heroimg" className={`md:w-full h-full object-cover rounded-sm`} />
        </div>

        <div className="md:p-2 md:px-6 md:w-1/2 xl:pr-8 xl:px-0">
          <h1
