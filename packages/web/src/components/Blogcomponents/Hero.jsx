     ...
     return(
          <section className="mb-10">
               <div className="md:flex justify-between items-center flex-row-reverse md:max-w-3xl md:mx-auto xl:max-w-5xl">
                    <div className="mb-4 md:w-80 md:h-full md:mb-0 md:p-0 xl:w-3/4">
                         <img src ={Heroimg} alt="Heroimg" className="md:w-full md:h-full" />
                    </div>

                    <div className="p-4 md:p-6">
                         <h1 className={`text-header ${context.theme === 'dark' ? 'text-white' : null} text-xl font-bold mb-3 text-center md:text-left xl:text-3xl transition-all`}>The Time Is Now for Conversational AI</h1>
                         ...
                         <Link to="/ai" className="text-header text-sm font-bold mb-3 text-left hover:text-[#5d387f]">Read more</Link>
                    </div>  
               </div>
