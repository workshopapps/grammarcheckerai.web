      ...
      <div className="w-[80%] mx-auto">
        <header className="py-7 max-w-md">
          <h2
            ...
            } mb-4 text-xl md:text-3xl font-black md:whitespace-nowrap`}
          >
