...
const FaqBox = ({ question, details }) => {
  ...
  return (
    <div className={` flex flex-col justify-between border-2 mb-5 rounded-lg ${context.theme === 'dark' ? 'text-[#fff7f7] border-[#b6afb8]' :  'text-[#141414] border-[#bbb7b7]'}`}>
      <div
        onClick={handleOpen}
