...
const Utilise = () => {
    ...
    return (
        <section className={`w-[90%] md:w-[80%] mx-auto ${context.theme === 'dark' ? 'shadow-[#1f1e1e]' : 'shadow-[#c5bfbf]'} flex flex-col justify-center items-center gap-5 text-center bg-[#5D387F] rounded-md my-20 py-16 px-8 text-white relative
        md:flex-row`}>
...
//   return (
//     <section
//       className={`w-[90%] max-w-7xl mx-auto shadow-xl ${
...
//         <h4 className="text-2xl mb-4">Utilise the power of AI</h4>
//         <p>Use Gritty Grammar speech correcton bot and never worry about your speech again.</p>
//       </div>
//       <button
//         type="button"
