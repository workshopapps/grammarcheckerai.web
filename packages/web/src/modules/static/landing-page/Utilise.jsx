...
const Utilise = () => {
    ...
    return (
        <section className={`w-[90%] max-w-7xl mx-auto shadow-xl ${context.theme === 'dark' ? 'shadow-[#1f1e1e]' : 'shadow-[#c5bfbf]'} flex flex-col justify-center items-center gap-5 text-center bg-[#5D387F] rounded-md my-20 py-16 px-8 text-white relative
        md:flex-row`}>
