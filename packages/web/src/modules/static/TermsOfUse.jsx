    ...
    <div className="overflow-hidden">
      <div className={`${context.theme === 'dark' ? 'text-[#211f21]' : 'text-[#ffff]'} lg:h-[430px] h-[296px] bg-[#5D387F] `}>
        <div className="lg:pt-[156px] pt-[112px]">
         ...
         <p className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#ffff]'} p-4 lg:p-0 lg:text-[20px] text-[14px] lg:leading-[26px] leading-[18px] text-center`}>Get familiar with our terms and enjoy Speak Better to the fullest.</p>
        </div>

      </div>
      <div className="_termspage">
        <span className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#989595]'} lg:text-[14px] lg:leading-[30px] text-[10px] leading:[20px]`}> EFFECTIVE AS OF NOVEMBER 18,2022</span>
        <br></br>
        <span className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[28px] lg:leading-[62px] text-[24px] leading:[31px] font-bold mt-[16px]`}> Terms of use</span>
        <p className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[20px] lg:leading-[36px] text-[16px] leading:[24px] lg:mt-[24px] mt-[8px] lg:break-normal break-word`}>
        ...
        <h1 className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[28px] lg:leading-[52px] text-[24px] leading:[31px] font-bold lg:mt-[64px] mt-[46px]`}>Registration and security</h1>
        <p className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[20px] lg:leading-[36px] text-[16px] leading:[24px] lg:mt-[24px] mt-[8px] lg:break-normal break-word`}>
        ...
        <h1 className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[28px] lg:leading-[52px] text-[24px] leading:[31px] font-bold lg:mt-[64px] mt-[46px]`}>Access to services</h1>
        <p className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[20px] lg:leading-[36px] text-[16px] leading:[24px] lg:mt-[24px] mt-[8px] lg:break-normal break-word`}>
        ...
        <h1 className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[28px] lg:leading-[52px] text-[24px] leading:[31px] font-bold lg:mt-[64px] mt-[46px]`}>Mobile Services</h1>
        <p className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[20px] lg:leading-[36px] text-[16px] leading:[24px] lg:mt-[24px] mt-[8px] lg:break-normal break-word`}>
        ...
        <h1 className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[28px] lg:leading-[52px] text-[24px] leading:[31px] font-bold lg:mt-[64px] mt-[46px]`}>Changes to terms or services</h1>
        <p className={`${context.theme === 'dark' ? 'text-[#ffff]' : 'text-[#393939]'} lg:text-[20px] lg:leading-[36px] text-[16px] leading:[24px] lg:mt-[24px] mt-[8px] lg:break-normal break-word`}>
        ...
        (ii)suspenZd or discontinue, temporarily or permanently, any or all of the Services or any Trial, including the availability of any feature, database or content or <br></br>
