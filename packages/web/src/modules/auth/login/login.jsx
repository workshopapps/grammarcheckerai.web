              ...
              <div className={styles._gs2sociallogincol}>
                ...
                <div className={styles._gs2sociallogins}>
                  ...
                  <button type="button" className={styles._apple}>
                    <a href="https://www.linkedin.com/oauth/v2/authorization?response_type=code&scope=r_liteprofile%20r_emailaddress&client_id=77cy5gqnolzhra&redirect_uri=https://speakbetter.hng.tech/">
