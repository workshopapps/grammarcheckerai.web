...
const flw = new Flutterwave('FLWPUBK_TEST-ab96bfc24d101b7af5933ca120fdb1a7-X', 'FLWSECK_TEST-204488a850fd0dca39e00cfba88d40f6-X'  );
...
const activateSubscription = async () => {
    ...
    try {
        const payload={
            "id":"31036" //This is the unique id of the subscription you want to activate. It is returned in the Get a subscription call as data.id
        }
