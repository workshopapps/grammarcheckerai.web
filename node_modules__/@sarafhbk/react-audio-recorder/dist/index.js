...
(function (RECORD_STATUS) {
  RECORD_STATUS["IDLE"] = "idle";
  RECORD_STATUS["RECORDING"] = "recording";
  RECORD_STATUS["PAUSED"] = "paused";
})(exports.RECORD_STATUS || (exports.RECORD_STATUS = {}));
...
var useAudioRecorder = function useAudioRecorder() {
  ...
  var _useState = react.useState(exports.RECORD_STATUS.IDLE),
      status = _useState[0],
  ...
  var startRecording = function startRecording() {
    if (status === exports.RECORD_STATUS.IDLE) {
      try {
        setErrorMessage('');
        navigator.mediaDevices.getUserMedia({
          ...
          mediaRecorder.onstart = function () {
            handleStartTimer();
            setStatus(exports.RECORD_STATUS.RECORDING);
          };
  ...
  var resumeRecording = function resumeRecording() {
    if (status === exports.RECORD_STATUS.PAUSED) {
  ...
  var pauseRecording = function pauseRecording() {
    if (status === exports.RECORD_STATUS.RECORDING) {
      mediaRecorder.pause();

      mediaRecorder.onpause = function () {
        handlePauseTimer();
        setStatus(exports.RECORD_STATUS.PAUSED);
      };
    } else {
      return;
    }
  ...
  var stopRecording = function stopRecording() {
    if (status !== exports.RECORD_STATUS.IDLE) {
      ...
      mediaRecorder.onstop = function () {
        ...
        setStatus(exports.RECORD_STATUS.IDLE);
...
exports.ReactAudioRecorder = ReactAudioRecorder;
